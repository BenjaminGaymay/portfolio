...
export class Monster extends UpdatableObject {
	constructor() {
		super()
	...
	regularShoot() {
		...
		this.events.add(JSON.stringify({ name: 'world.invokeMonsterBullet', params: { position: br, direction: this.direction } }))
		this.events.add(JSON.stringify({ name: 'world.invokeMonsterBullet', params: { position: tr, direction: this.direction } }))
		this.events.add(JSON.stringify({ name: 'world.invokeMonsterBullet', params: { position: bl, direction: this.direction } }))
		this.events.add(JSON.stringify({ name: 'world.invokeMonsterBullet', params: { position: tl, direction: this.direction } }))
	}
